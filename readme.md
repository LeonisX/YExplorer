...
был трабл с дампом германского перевода, вроде решил.
для верности надо сдампить список всех используемых букв и при дампе экшенов и паззлов делать проверку на неиспользуемые
